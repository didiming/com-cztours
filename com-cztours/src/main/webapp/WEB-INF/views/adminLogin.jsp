...
<body>
	...
	<script type="resources/text/javascript" src="js/jquery-ui.min.js"></script>
    ...
    <script src="resources/js/Particleground.js" type="text/javascript"></script>
    <script src="resources/js/Treatment.js" type="text/javascript"></script>
    <script src="resources/js/jquery.mockjax.js" type="text/javascript"></script>
